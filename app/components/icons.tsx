// Simple icons component to replace lucide-react
import React from 'react';

export const Camera = ({ className }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor">
    <path d="M9 2l1.17 1H15c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H5c-1.1 0-2-.9-2-2V5c0-1.1.9-2 2-2h3.17L9 2zm3 15c2.76 0 5-2.24 5-5s-2.24-5-5-5-5 2.24-5 5 2.24 5 5 5z"/>
  </svg>
);

export const Download = ({ className }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor">
    <path d="M12 15.5l-4-4h3V4h2v7.5h3l-4 4zM5 20v-2h14v2H5z"/>
  </svg>
);

export const FolderOpen = ({ className }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor">
    <path d="M4 6h8l2-2h6a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2zm0 2v10h16V8l-6 6-8-6z"/>
  </svg>
);
...
export const Monitor = ({ className }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor">
    <path d="M20 3H4c-1.103 0-2 .897-2 2v10c0 1.103.897 2 2 2h6v2H8v2h8v-2h-2v-2h6c1.103 0 2-.897 2-2V5c0-1.103-.897-2-2-2zM4 15V5h16l.002 10H4z"/>
  </svg>
);
...
export const Info = ({ className }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor">
    <path d="M12,2C6.48,2 2,6.48 2,12C2,17.52 6.48,22 12,22C17.52,22 22,17.52 22,12C22,6.48 17.52,2 12,2M13,17H11V11H13M13,9H11V7H13"/>
  </svg>
);